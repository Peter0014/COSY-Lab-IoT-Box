...
SOFTWARE_UPDATE_URL=127.0.0.1/updatesite/
PUBLIC_KEY_FILE=/home/pi/Desktop/custominstallerbuilder/Peter0014.publickey
PRIVATE_KEY_FILE=/home/pi/Desktop/custominstallerbuilder/Peter0014.privatekey

e=`cat $PUBLIC_KEY_FILE | cut -d' ' -f 1`
n=`cat $PUBLIC_KEY_FILE | cut -d' ' -f 2`
SOFTWARE_UPDATE_KEY="{'e':$e, 'n':$n}"

REPO_PARENT_DIR=/home/pi/Desktop/custominstallerbuilder/DEPENDENCIES
